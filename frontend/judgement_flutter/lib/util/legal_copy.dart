...
4. Table media
Emotes, soundboard clips, and short voice notes are shared with players currently at your table for that game. Do not share passwords, payment details, or other sensitive information. Microphone access requires a separate browser permission and is only used when you choose to send a voice note.
...
1. Who we are
$kLegalOperatorName operates this Judgement web app. Contact: $kLegalOperatorEmail
...
5. Retention
Live game state is retained according to server policies (lobbies and finished games are cleaned up on a short schedule). RSVP mobile numbers are kept only as needed for the event and related host contact, then removed. Clearing your browser site data removes local consent and client-side preferences.

6. Your choices
You may decline optional event contact consent, deny microphone permission in your browser, leave a table at any time, and clear this site’s data in your browser settings.
